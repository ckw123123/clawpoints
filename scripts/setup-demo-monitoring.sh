...
echo ""
echo "💡 Next Steps:"
echo "  1. Open demo-analytics.html to view deployment summary"
echo "  2. Test the demo at: https://$(jq -r '.cloudfrontDomain' deployment-info.json)"
echo "  3. Monitor performance via CloudWatch dashboard"
echo "  4. Check AWS costs in billing console"